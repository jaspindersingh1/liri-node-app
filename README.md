...
What our app does depends on what the user types, and there are 4 main functions: (1) prints default movie, (2) Spotify lookup for a song, (3) OMDb lookup for a movie, and (4) read command and query from another file
